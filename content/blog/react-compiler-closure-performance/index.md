...
**바쁜 분들을 위한 TLDR**: Sathya는 맞기도 하고 틀리기도 했습니다. 그가 맞다는 것은 제 예제 코드가 더 이상 엄청난 양의 메모리를 할당하지 않기 때문입니다. 그가 틀린 것은 불행히도 리액트 컴파일러가 클로저 메모리 누수를 방지하지 못하기 때문입니다. 아래에서 자세히 살펴보겠습니다.
